...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* Desktop: overlays on full-screen bg. Light wash at the bottom so the
          dark headline below stays legible over the photo. */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 hidden lg:block"
        style={{ background: "linear-gradient(to bottom, transparent 46%, rgba(255,255,255,0.72) 100%)" }}
      />
      ...
      <div className="relative z-[2] mt-auto hidden pb-12 lg:block lg:pb-16">
        <Container>
          <div className="max-w-[960px]">
            ...
            <h1 className="text-[2rem] font-semibold leading-[1.08] text-foreground sm:text-[2.6rem] md:text-[3.2rem] lg:text-[clamp(3rem,4.2vw,4rem)]">
              Стоматологическое оборудование, запасные части и комплектующие
            </h1>
            <p className="mt-5 max-w-[520px] text-base leading-7 text-foreground/80 sm:text-[1.05rem]">
              Подберём оборудование, комплектующие и расходные позиции под задачи вашей клиники.
            </p>
